...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self._img1 = tk.PhotoImage(file="B:\Pythonproject\mouzika\icons\pause.png")
        ...
        self._img2 = tk.PhotoImage(file="B:\Pythonproject\mouzika\icons\play.png")
        ...
        self._img3 = tk.PhotoImage(file="B:\Pythonproject\mouzika\icons\stop.png")
...
class Player:
    ...
    def add_song(self):
        song_name=self.myplayer.add_song()
        if song_name is None:
            return
        self.playlist.insert(tk.END,song_name)
        rcolor= lambda: random.randint(0,225)
        red= hex(rcolor())
        green = hex(rcolor())
        blue=hex(rcolor())
        red=red[2:]
        ...
        print(mycolor)
        self.playList.configuration(fg=mycolor)
    ...
    def show_song_details(self):
        self.song_length=self.myplayer.get_song_length()
    ...
    def close_window(self):
        ...
        if (result):
            ...
            messagebox.showinfo("Having a ")

    def load_previous_song(self):
        try:
            if hasattr(self,"sel_song_index_tuple")==False:
                raise NoSongSelectionError("Please select a song first")
    ...
    def add_song_to_favourites(self):
        ...
        try:
            ...
            print(ex1)
        except(DatabaseError) as ax1:
            messagebox.showerrror("Error..!",ex1)
            print(ex1)
